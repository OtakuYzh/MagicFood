...
export class SAP<T = unknown> {
    ...
    /**
     * 碰撞检测
     * @param callback 碰撞回调(允许移除回调函数中的两个碰撞体，但其它碰撞体需要在trigger运行完毕后移除，否则会报错)
     * @param target 碰撞回调的this
     */
    ...
    public clear() {
        this.bodies.forEach(body => {
            Body.off(body, BodyEvent.AABB_CHANGED, this.refresh, this);
        });
        this.dirty = false;
